...
// Last Modified : 2026/08/10 07:00:53
...
<div class="row row-overflow">
  ...
  <div class="col-xs-12 eqLogicThumbnailDisplay">
    ...
    <legend><i class="fas fa-table"></i> {{Mes OZW}}</legend>
    <?php
    if (count($eqLogics) == 0) {
      echo '<br><div class="text-center" style="font-size:1.2em;font-weight:bold;">{{Aucun équipement OZW trouvé, cliquer sur "Ajouter" pour commencer}}</div>';
    } else {
      // Champ de recherche
      ...
      foreach ($eqLogics as $eqLogic) {
        ...
        $file = 'plugins/OZW/plugin_info/' . $eqLogic->getConfiguration('icon') . '.png';
          ...
          <fieldset>
            ...
            <div class="col-lg-8">
              ...
              <div class="form-group">
                <label class="col-sm-4 control-label">{{Nom de l'OZW}}</label>
                <div class="col-sm-6">
                  <input type="text" class="eqLogicAttr form-control" data-l1key="id" style="display:none;">
                  <input type="text" class="eqLogicAttr form-control" data-l1key="name" placeholder="{{Nom de l'OZW}}">
                </div>
              </div>
              <div class="form-group">
